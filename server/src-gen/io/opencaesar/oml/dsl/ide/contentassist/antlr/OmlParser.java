...
public class OmlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OmlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEntitySpecializationAccess().getAlternatives_1(), "rule__EntitySpecialization__Alternatives_1");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getAlternatives(), "rule__EntityEquivalenceAxiom__Alternatives");
			...
			builder.put(grammarAccess.getEntitySpecializationAccess().getGroup(), "rule__EntitySpecialization__Group__0");
			builder.put(grammarAccess.getEntitySpecializationAccess().getGroup_1_0(), "rule__EntitySpecialization__Group_1_0__0");
			builder.put(grammarAccess.getEntitySpecializationAccess().getGroup_1_0_1(), "rule__EntitySpecialization__Group_1_0_1__0");
			builder.put(grammarAccess.getEntitySpecializationAccess().getGroup_1_1(), "rule__EntitySpecialization__Group_1_1__0");
			builder.put(grammarAccess.getEntitySpecializationAccess().getGroup_1_1_0(), "rule__EntitySpecialization__Group_1_1_0__0");
			builder.put(grammarAccess.getEntitySpecializationAccess().getGroup_1_1_0_1(), "rule__EntitySpecialization__Group_1_1_0_1__0");
			builder.put(grammarAccess.getEntityEquivalenceAccess().getGroup(), "rule__EntityEquivalence__Group__0");
			builder.put(grammarAccess.getEntityEquivalenceAccess().getGroup_2(), "rule__EntityEquivalence__Group_2__0");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getGroup_0(), "rule__EntityEquivalenceAxiom__Group_0__0");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getGroup_0_1(), "rule__EntityEquivalenceAxiom__Group_0_1__0");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getGroup_1(), "rule__EntityEquivalenceAxiom__Group_1__0");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getGroup_1_1(), "rule__EntityEquivalenceAxiom__Group_1_1__0");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getGroup_1_1_1(), "rule__EntityEquivalenceAxiom__Group_1_1_1__0");
			...
			builder.put(grammarAccess.getAnonymousConceptInstanceAccess().getGroup(), "rule__AnonymousConceptInstance__Group__0");
			builder.put(grammarAccess.getAnonymousConceptInstanceAccess().getGroup_1(), "rule__AnonymousConceptInstance__Group_1__0");
			...
			builder.put(grammarAccess.getEntitySpecializationAccess().getOwnedSpecializationsAssignment_1_0_0(), "rule__EntitySpecialization__OwnedSpecializationsAssignment_1_0_0");
			builder.put(grammarAccess.getEntitySpecializationAccess().getOwnedSpecializationsAssignment_1_0_1_1(), "rule__EntitySpecialization__OwnedSpecializationsAssignment_1_0_1_1");
			builder.put(grammarAccess.getEntitySpecializationAccess().getOwnedSpecializationsAssignment_1_1_0_0(), "rule__EntitySpecialization__OwnedSpecializationsAssignment_1_1_0_0");
			builder.put(grammarAccess.getEntitySpecializationAccess().getOwnedSpecializationsAssignment_1_1_0_1_1(), "rule__EntitySpecialization__OwnedSpecializationsAssignment_1_1_0_1_1");
			builder.put(grammarAccess.getEntitySpecializationAccess().getOwnedPropertyRestrictionsAssignment_1_1_2(), "rule__EntitySpecialization__OwnedPropertyRestrictionsAssignment_1_1_2");
			builder.put(grammarAccess.getEntityEquivalenceAccess().getOwnedEquivalencesAssignment_1(), "rule__EntityEquivalence__OwnedEquivalencesAssignment_1");
			builder.put(grammarAccess.getEntityEquivalenceAccess().getOwnedEquivalencesAssignment_2_1(), "rule__EntityEquivalence__OwnedEquivalencesAssignment_2_1");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getSuperEntitiesAssignment_0_0(), "rule__EntityEquivalenceAxiom__SuperEntitiesAssignment_0_0");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getSuperEntitiesAssignment_0_1_1(), "rule__EntityEquivalenceAxiom__SuperEntitiesAssignment_0_1_1");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getSuperEntitiesAssignment_1_1_0(), "rule__EntityEquivalenceAxiom__SuperEntitiesAssignment_1_1_0");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getSuperEntitiesAssignment_1_1_1_1(), "rule__EntityEquivalenceAxiom__SuperEntitiesAssignment_1_1_1_1");
			builder.put(grammarAccess.getEntityEquivalenceAxiomAccess().getOwnedPropertyRestrictionsAssignment_1_3(), "rule__EntityEquivalenceAxiom__OwnedPropertyRestrictionsAssignment_1_3");
			...
			builder.put(grammarAccess.getAnonymousConceptInstanceAccess().getTypeAssignment_1_1(), "rule__AnonymousConceptInstance__TypeAssignment_1_1");
			builder.put(grammarAccess.getAnonymousConceptInstanceAccess().getOwnedPropertyValuesAssignment_3(), "rule__AnonymousConceptInstance__OwnedPropertyValuesAssignment_3");
