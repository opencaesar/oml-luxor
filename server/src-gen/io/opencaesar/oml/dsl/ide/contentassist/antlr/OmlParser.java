...
public class OmlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OmlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAnnotationAccess().getAlternatives_3(), "rule__Annotation__Alternatives_3");
			...
			builder.put(grammarAccess.getPropertyRangeRestrictionAxiomAccess().getAlternatives(), "rule__PropertyRangeRestrictionAxiom__Alternatives");
			builder.put(grammarAccess.getPropertyCardinalityRestrictionAxiomAccess().getAlternatives(), "rule__PropertyCardinalityRestrictionAxiom__Alternatives");
			builder.put(grammarAccess.getPropertyValueRestrictionAxiomAccess().getAlternatives(), "rule__PropertyValueRestrictionAxiom__Alternatives");
			...
			builder.put(grammarAccess.getScalarAccess().getGroup_2_1_0(), "rule__Scalar__Group_2_1_0__0");
			builder.put(grammarAccess.getScalarAccess().getGroup_2_1_1(), "rule__Scalar__Group_2_1_1__0");
			builder.put(grammarAccess.getScalarAccess().getGroup_2_1_2(), "rule__Scalar__Group_2_1_2__0");
			builder.put(grammarAccess.getScalarAccess().getGroup_2_1_3(), "rule__Scalar__Group_2_1_3__0");
			builder.put(grammarAccess.getScalarAccess().getGroup_2_1_4(), "rule__Scalar__Group_2_1_4__0");
			builder.put(grammarAccess.getScalarAccess().getGroup_2_1_5(), "rule__Scalar__Group_2_1_5__0");
			builder.put(grammarAccess.getScalarAccess().getGroup_2_1_6(), "rule__Scalar__Group_2_1_6__0");
			builder.put(grammarAccess.getScalarAccess().getGroup_2_1_7(), "rule__Scalar__Group_2_1_7__0");
			builder.put(grammarAccess.getScalarAccess().getGroup_2_1_8(), "rule__Scalar__Group_2_1_8__0");
			...
			builder.put(grammarAccess.getRelationValueRestrictionAxiomAccess().getGroup(), "rule__RelationValueRestrictionAxiom__Group__0");
			...
			builder.put(grammarAccess.getAnnotationAccess().getLiteralValueAssignment_3_0(), "rule__Annotation__LiteralValueAssignment_3_0");
			builder.put(grammarAccess.getAnnotationAccess().getReferenceValueAssignment_3_1(), "rule__Annotation__ReferenceValueAssignment_3_1");
			...
			builder.put(grammarAccess.getScalarAccess().getLengthAssignment_2_1_0_1(), "rule__Scalar__LengthAssignment_2_1_0_1");
			builder.put(grammarAccess.getScalarAccess().getMinLengthAssignment_2_1_1_1(), "rule__Scalar__MinLengthAssignment_2_1_1_1");
			builder.put(grammarAccess.getScalarAccess().getMaxLengthAssignment_2_1_2_1(), "rule__Scalar__MaxLengthAssignment_2_1_2_1");
			builder.put(grammarAccess.getScalarAccess().getPatternAssignment_2_1_3_1(), "rule__Scalar__PatternAssignment_2_1_3_1");
			builder.put(grammarAccess.getScalarAccess().getLanguageAssignment_2_1_4_1(), "rule__Scalar__LanguageAssignment_2_1_4_1");
			builder.put(grammarAccess.getScalarAccess().getMinInclusiveAssignment_2_1_5_1(), "rule__Scalar__MinInclusiveAssignment_2_1_5_1");
			builder.put(grammarAccess.getScalarAccess().getMinExclusiveAssignment_2_1_6_1(), "rule__Scalar__MinExclusiveAssignment_2_1_6_1");
			builder.put(grammarAccess.getScalarAccess().getMaxInclusiveAssignment_2_1_7_1(), "rule__Scalar__MaxInclusiveAssignment_2_1_7_1");
			builder.put(grammarAccess.getScalarAccess().getMaxExclusiveAssignment_2_1_8_1(), "rule__Scalar__MaxExclusiveAssignment_2_1_8_1");
			builder.put(grammarAccess.getScalarAccess().getOwnedEnumerationAssignment_2_1_9(), "rule__Scalar__OwnedEnumerationAssignment_2_1_9");
			...
			builder.put(grammarAccess.getScalarPropertyRangeRestrictionAxiomAccess().getKindAssignment_1(), "rule__ScalarPropertyRangeRestrictionAxiom__KindAssignment_1");
			builder.put(grammarAccess.getScalarPropertyRangeRestrictionAxiomAccess().getPropertyAssignment_4(), "rule__ScalarPropertyRangeRestrictionAxiom__PropertyAssignment_4");
			builder.put(grammarAccess.getScalarPropertyRangeRestrictionAxiomAccess().getRangeAssignment_6(), "rule__ScalarPropertyRangeRestrictionAxiom__RangeAssignment_6");
			builder.put(grammarAccess.getStructuredPropertyRangeRestrictionAxiomAccess().getKindAssignment_1(), "rule__StructuredPropertyRangeRestrictionAxiom__KindAssignment_1");
			builder.put(grammarAccess.getStructuredPropertyRangeRestrictionAxiomAccess().getPropertyAssignment_4(), "rule__StructuredPropertyRangeRestrictionAxiom__PropertyAssignment_4");
			builder.put(grammarAccess.getStructuredPropertyRangeRestrictionAxiomAccess().getRangeAssignment_6(), "rule__StructuredPropertyRangeRestrictionAxiom__RangeAssignment_6");
			builder.put(grammarAccess.getRelationRangeRestrictionAxiomAccess().getKindAssignment_1(), "rule__RelationRangeRestrictionAxiom__KindAssignment_1");
			builder.put(grammarAccess.getRelationRangeRestrictionAxiomAccess().getPropertyAssignment_3(), "rule__RelationRangeRestrictionAxiom__PropertyAssignment_3");
			builder.put(grammarAccess.getRelationRangeRestrictionAxiomAccess().getRangeAssignment_5(), "rule__RelationRangeRestrictionAxiom__RangeAssignment_5");
			builder.put(grammarAccess.getScalarPropertyCardinalityRestrictionAxiomAccess().getPropertyAssignment_3(), "rule__ScalarPropertyCardinalityRestrictionAxiom__PropertyAssignment_3");
			builder.put(grammarAccess.getScalarPropertyCardinalityRestrictionAxiomAccess().getKindAssignment_5(), "rule__ScalarPropertyCardinalityRestrictionAxiom__KindAssignment_5");
			builder.put(grammarAccess.getScalarPropertyCardinalityRestrictionAxiomAccess().getCardinalityAssignment_6(), "rule__ScalarPropertyCardinalityRestrictionAxiom__CardinalityAssignment_6");
			builder.put(grammarAccess.getScalarPropertyCardinalityRestrictionAxiomAccess().getRangeAssignment_7(), "rule__ScalarPropertyCardinalityRestrictionAxiom__RangeAssignment_7");
			builder.put(grammarAccess.getStructuredPropertyCardinalityRestrictionAxiomAccess().getPropertyAssignment_3(), "rule__StructuredPropertyCardinalityRestrictionAxiom__PropertyAssignment_3");
			builder.put(grammarAccess.getStructuredPropertyCardinalityRestrictionAxiomAccess().getKindAssignment_5(), "rule__StructuredPropertyCardinalityRestrictionAxiom__KindAssignment_5");
			builder.put(grammarAccess.getStructuredPropertyCardinalityRestrictionAxiomAccess().getCardinalityAssignment_6(), "rule__StructuredPropertyCardinalityRestrictionAxiom__CardinalityAssignment_6");
			builder.put(grammarAccess.getStructuredPropertyCardinalityRestrictionAxiomAccess().getRangeAssignment_7(), "rule__StructuredPropertyCardinalityRestrictionAxiom__RangeAssignment_7");
			builder.put(grammarAccess.getRelationCardinalityRestrictionAxiomAccess().getPropertyAssignment_2(), "rule__RelationCardinalityRestrictionAxiom__PropertyAssignment_2");
			builder.put(grammarAccess.getRelationCardinalityRestrictionAxiomAccess().getKindAssignment_4(), "rule__RelationCardinalityRestrictionAxiom__KindAssignment_4");
			builder.put(grammarAccess.getRelationCardinalityRestrictionAxiomAccess().getCardinalityAssignment_5(), "rule__RelationCardinalityRestrictionAxiom__CardinalityAssignment_5");
			builder.put(grammarAccess.getRelationCardinalityRestrictionAxiomAccess().getRangeAssignment_6(), "rule__RelationCardinalityRestrictionAxiom__RangeAssignment_6");
			builder.put(grammarAccess.getScalarPropertyValueRestrictionAxiomAccess().getPropertyAssignment_3(), "rule__ScalarPropertyValueRestrictionAxiom__PropertyAssignment_3");
			builder.put(grammarAccess.getScalarPropertyValueRestrictionAxiomAccess().getLiteralValueAssignment_5(), "rule__ScalarPropertyValueRestrictionAxiom__LiteralValueAssignment_5");
			builder.put(grammarAccess.getStructuredPropertyValueRestrictionAxiomAccess().getPropertyAssignment_3(), "rule__StructuredPropertyValueRestrictionAxiom__PropertyAssignment_3");
			builder.put(grammarAccess.getStructuredPropertyValueRestrictionAxiomAccess().getStructureInstanceValueAssignment_5(), "rule__StructuredPropertyValueRestrictionAxiom__StructureInstanceValueAssignment_5");
			builder.put(grammarAccess.getRelationValueRestrictionAxiomAccess().getPropertyAssignment_2(), "rule__RelationValueRestrictionAxiom__PropertyAssignment_2");
			builder.put(grammarAccess.getRelationValueRestrictionAxiomAccess().getNamedInstanceValueAssignment_4(), "rule__RelationValueRestrictionAxiom__NamedInstanceValueAssignment_4");
			builder.put(grammarAccess.getPropertySelfRestrictionAxiomAccess().getPropertyAssignment_2(), "rule__PropertySelfRestrictionAxiom__PropertyAssignment_2");
			...
			builder.put(grammarAccess.getScalarPropertyValueAssertionAccess().getPropertyAssignment_0(), "rule__ScalarPropertyValueAssertion__PropertyAssignment_0");
			builder.put(grammarAccess.getScalarPropertyValueAssertionAccess().getLiteralValueAssignment_1(), "rule__ScalarPropertyValueAssertion__LiteralValueAssignment_1");
			builder.put(grammarAccess.getStructuredPropertyValueAssertionAccess().getPropertyAssignment_0(), "rule__StructuredPropertyValueAssertion__PropertyAssignment_0");
			builder.put(grammarAccess.getStructuredPropertyValueAssertionAccess().getStructureInstanceValueAssignment_1(), "rule__StructuredPropertyValueAssertion__StructureInstanceValueAssignment_1");
			builder.put(grammarAccess.getLinkAssertionAccess().getPropertyAssignment_0(), "rule__LinkAssertion__PropertyAssignment_0");
			builder.put(grammarAccess.getLinkAssertionAccess().getNamedInstanceValueAssignment_1(), "rule__LinkAssertion__NamedInstanceValueAssignment_1");
			...
			builder.put(grammarAccess.getScalarAccess().getUnorderedGroup_2_1(), "rule__Scalar__UnorderedGroup_2_1");
